...
class ZhTokenizer:
    def __init__(self):
        self.tokenizer = BertTokenizer.from_pretrained('pre_trained_bert/vocab.txt')
            ...
            if s2ro_map:
                ...
                for s in s2ro_map:
                    ...
                    for ro in s2ro_map.get((sub_head, sub_tail), []):
                        ...
                        # 头尾实体都是多token组成
                        if sub_head != sub_tail and obj_head != obj_tail:
                            triple_matrix[relation][sub_head][obj_head] = self.tag2id['BH2BT']
                            triple_matrix[relation][sub_head][obj_tail] = self.tag2id['BH2ET']
                            triple_matrix[relation][sub_tail][obj_tail] = self.tag2id['EH2ET']
                        # 头实体为单token组成
                        elif sub_head == sub_tail and obj_head != obj_tail:
                            triple_matrix[relation][sub_head][obj_head] = self.tag2id['SH2BT']
                            triple_matrix[relation][sub_tail][obj_tail] = self.tag2id['SH2ET']
                        # 尾实体为单token组成
                        elif sub_head != sub_tail and obj_head == obj_tail:
                            triple_matrix[relation][sub_head][obj_head] = self.tag2id['BH2ST']
                            triple_matrix[relation][sub_tail][obj_tail] = self.tag2id['EH2ST']
                        else:
                            triple_matrix[relation][sub_head][obj_head] = self.tag2id['SH2ST']
