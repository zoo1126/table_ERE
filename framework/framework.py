                ...
                if pair_numbers > 0:
                    ...
                    for i in range(pair_numbers):
                        ...
                        # 如果当前第一个标签是SH2BT
                            ...
                            # 如果下一个标签是SH2ET，找到了尾实体结尾的位置
                            t_end_index = tails[i+1]
                            if pred_triple_matrix[r_index][h_start_index][t_end_index] == tag2id['SH2ET']:
                        ...
                        # 如果当前第一个标签是BH2ST
                            ...
                            for h_end_index in range(h_start_index, seq_lens):
                                # 向下找到了结尾位置
                                if pred_triple_matrix[r_index][h_end_index][t_start_index] == tag2id['EH2ST']:
                                    sub_head, sub_tail = h_start_index, h_end_index
